...
bool HelloWorld::init()
{
	...
	auto item2 = MenuItemFont::create("pushSceneTran", CC_CALLBACK_1(HelloWorld::doPushSceneTran, this));
	...
	auto item4 = MenuItemFont::create("replaceSceneTran", CC_CALLBACK_1(HelloWorld::doReplaceSceneTran, this));
...
void HelloWorld::doPushSceneTran(Ref* pSender)
{
	// 두 번째 장면
	auto pScene = TestScene2::createScene();
	Director::getInstance()->pushScene(createTransition(1, 1, pScene));
}
...
void HelloWorld::doReplaceSceneTran(Ref* pSender)
{
	// 세 번째 장면
	auto pScene = TestScene3::createScene();
	Director::getInstance()->replaceScene(createTransition(14, 1, pScene));
}
...
TransitionScene* HelloWorld::createTransition(int nIndex, float t, Scene* s)
{
	...
	case 0: return TransitionJumpZoom::create(t, s);               // t = time, s = scene
