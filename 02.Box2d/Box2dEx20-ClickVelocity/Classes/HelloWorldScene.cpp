...
bool HelloWorld::createBox2dWorld(bool debug)
{
	...
	// 바디를 생성해서 월드에 추가한다.
	myBall = this->addNewSprite(Vec2(240, 160), Size(32, 32), b2_dynamicBody, "test", 0);
...
void HelloWorld::tick(float dt)
{
	...
	if (playerIsFlying)
	{
		myBall->ApplyLinearImpulse(b2Vec2(0, playerVelocity), myBall->GetWorldCenter(), true);

		playerVelocity = playerVelocity + 0.01f;
